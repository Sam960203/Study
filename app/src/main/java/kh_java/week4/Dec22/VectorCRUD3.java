...
public class VectorCRUD3 {
  ...
  public int deptUpdate(DeptVO pdVO) {
    ...
    String user = scan.nextLine();// 10|인사부|포항-> 10 개발부 인천
    int user_deptno = 0;
    String user_dname = null;
    String user_loc = null;
    // 문자열3개를 한번에 받아오기 위해 StringTokenizer 사용함- 메신저개발
  ...
  public static void main(String[] args) {
    ...
    choice = s.nextInt();
    if (choice == 1) {
      System.out.print("수정하고자 하는 부서번호를 입력하세요 ===> ");// 10혹은 20둘중하나
      int u_deptno = s.nextInt();// 10번 입력했다고 가정
      // 담을 수 있는 값은 부서번호 10뿐이다. dname에는 또 loc에는 뭐가 들어있죠?
