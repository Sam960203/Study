...
import javax.swing.JPanel;Abo04181
...
public class LoginForm extends JFrame implements ActionListener {
  ...
  String imgPath = "C:\\Users\\Nam Wung sik\\OneDrive\\바탕 화면\\Screen\\로그인창\\";
  ImageIcon imageIcon = new ImageIcon(imgPath + "로그인 창.jpg");
  JLabel jlb_id = new JLabel("아이디");
  JTextField jtf_id = new JTextField();
  JLabel jlb_pw = new JLabel("비밀번호");
  JPasswordField jpf_pw = new JPasswordField();
  Font font = new Font("굴림체", Font.BOLD, 15);
  JButton jbtn_join = new JButton(new ImageIcon(imgPath + "로그인버튼.jpg"));
